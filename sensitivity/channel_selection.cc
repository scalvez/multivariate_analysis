...
// void channel_selection(std::vector <TString> input_files, std::vector<TString> output_files, std::vector<TString> quantities_pdf, std::vector < std::map < TString,double > > & isotope_qty_eff, bool normalize)
void channel_selection( std::vector <TString> input_files)// , std::vector<TString> output_files, std::vector<TString> quantities_pdf, std::vector < std::map < TString,double > > & isotope_qty_eff, bool normalize)
{
